...
python /home/yurkis/esp/esp-idf/tools/idf_monitor.py --baud 115200 --port "${SERIAL}" --toolchain-prefix "xtensa-esp32-elf-" --make "make" --print_filter "" ${BASEDIR}/tests/build/esp/${PROJECT_NAME}.elf

else

${BASEDIR}/tests/build/pc/${PROJECT_NAME}
